...
const LandingPage = () => {
    ...
    return (
        <div className={`flex min-h-[75vh] items-center justify-center text-center cursor-default`}>
            ...
            <section className={`w-full p-8 bg-white border border-slate-100 shadow-sm shadow-slate-200/40 rounded-2xl px-12 py-16`}>
                ...
                <h2 className={`font-bold text-3xl text-slate-800 mb-4`}>Why should you use such an app?</h2>
                <h3 className={`font-medium text-xl text-slate-600 mb-12`}>Let me explain the 3-S!</h3>

                <ul className={`grid grid-cols-1 md:grid-cols-3 grid-rows-1 gap-8 justify-items-center items-center`}>

                    <li className={`border border-slate-100 rounded-lg p-6 shadow-sm shadow-slate-200/70 hover:border-sky-300 duration-300 transition`}>
